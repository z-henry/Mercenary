...
namespace Mercenary
{
	public static class TaskAdapter
	{
		public static void SetTask(int taskId, int mercenaryId, string title, string desc, List<Task> tasks, string progressMessage)
		{
				...
				case MercConst.先知维伦:
					{
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 0, "2-6", new MercenaryEntity[]
							{
				...
				case MercConst.奈法利安:
					{
						...
						if (title.Contains("暗影烈焰"))
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 0, new MercenaryEntity[]
							{
								...
								TaskAdapter.GetMercenary(MercConst.希奈丝特拉, "法力壁垒", 1, -1, HsMercenaryStrategy.TARGETTYPE.FRIENDLY),
								TaskAdapter.GetMercenary(MercConst.玉珑, "玉火打击", 0)
							}));
							return;
						}
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 0, "H1-2", new MercenaryEntity[]
							{
				...
				case MercConst.奥妮克希亚:
					{
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 5, "H2-6", new MercenaryEntity[]
							{
				...
				case MercConst.尤朵拉:
					{
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 5, "H1-1", new MercenaryEntity[]
							{
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 5, "2-5", new MercenaryEntity[]
							{
				...
				case MercConst.拉索利安:
					{
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 5, new MercenaryEntity[]
							{
				...
				case MercConst.斯尼德:
					{
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 0, "H1-1", new MercenaryEntity[]
							{
				...
				case MercConst.泰瑞尔:
					{
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 0, "1-10", new MercenaryEntity[]
							{
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 0, "H1-9", new MercenaryEntity[]
							{
								TaskAdapter.GetMercenary(MercConst.巴琳达_斯通赫尔斯, "烈焰之刺", 1),
								TaskAdapter.GetMercenary(MercConst.迦顿男爵,"地狱火", 1),
								TaskAdapter.GetMercenary(MercConst.拉格纳罗斯,"死吧，虫子", 2),
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 0, "H2-6", new MercenaryEntity[]
							{
								TaskAdapter.GetMercenary(MercConst.巴琳达_斯通赫尔斯, "烈焰之刺", 1),
								TaskAdapter.GetMercenary(MercConst.迦顿男爵,"地狱火", 1),
								TaskAdapter.GetMercenary(MercConst.拉格纳罗斯,"死吧，虫子", 2),
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 0, "H5-2", new MercenaryEntity[]
							{
								TaskAdapter.GetMercenary(MercConst.巴琳达_斯通赫尔斯, "烈焰之刺", 1),
								TaskAdapter.GetMercenary(MercConst.迦顿男爵,"地狱火", 1),
								TaskAdapter.GetMercenary(MercConst.拉格纳罗斯,"死吧，虫子", 2),
				...
				case MercConst.瓦里安_乌瑞恩:
					{
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 4, "2-5", new MercenaryEntity[]
							{
				...
				case MercConst.老瞎眼:
					{
						...
						{
							tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 5, "2-6", new MercenaryEntity[]
							{
			...
			{
				tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 5, "4-1", new MercenaryEntity[]
				{
					TaskAdapter.GetMercenary(mercenaryId, null, 0)
				}));
				return;
			...
			{
				tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 5, "H1-2", new MercenaryEntity[]
				{
					TaskAdapter.GetMercenary(mercenaryId, null, 0)
				}));
				return;
			...
			{
				tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 5, "7-1", new MercenaryEntity[]
				{
					TaskAdapter.GetMercenary(mercenaryId, null, 0)
				}));
				return;
			...
			{
				tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 5, "2-5", TaskAdapter.GetQuickMercenary(mercenaryId)));
				return;
			}
			...
			{
				tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 1, "H1-1", new MercenaryEntity[]
				{
					TaskAdapter.GetMercenary(mercenaryId, null, 0)
				}));
				return;
			...
			if (desc.Contains("完成") && desc.Contains("个悬赏"))
			{
				...
				{
					tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 10, new MercenaryEntity[]
					{
						TaskAdapter.GetMercenary(mercenaryId, null, 0)
					}));
				}
				...
				{
					tasks.Add(TaskAdapter.GetTask(mercenaryId, progressMessage, taskId, 10, "H1-1", new MercenaryEntity[]
					{
						TaskAdapter.GetMercenary(mercenaryId, null, 0)
					}));
				}
		...
		private static Task GetTask(int mercid, string progress, int id, int priority, params MercenaryEntity[] mercenaries)
		{
			return new Task
			{
				water = ++m_globalWater,
		...
		{
			{
				...
				if (match.Groups.Count == 2)
				{
					...
					tasks.Add(TaskAdapter.GetTask(-1, "", -1, 0, mapName, null));
					return;
				}
				...
				switch (desc)
				{
					//贫瘠之地
					case "击败8只野兽。":
						tasks.Add(TaskAdapter.GetTask(-1, "", -1, 0, "1-6", null));
						break;
					//费伍德森林
					case "在费伍德森林击败20个敌人。":
					...
					case "击败12个熊怪。":
					case "在冬泉谷完成3个悬赏。":
						tasks.Add(TaskAdapter.GetTask(-1, "", -1, 0, "3-1", null));
						break;
					//黑石山
					case "在黑石山造成2000点伤害。":
					case "在黑石山击败50个敌人。":
					...
					case "在奥特兰克山谷击败25个敌人。":
					case "在奥特兰克造成2000点伤害。":
						tasks.Add(TaskAdapter.GetTask(-1, "", -1, 0, "5-1", null));
						break;
				}
			}
		}
